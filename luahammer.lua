...
function fix(po)
	pcall(function()
		pcall(game.Destroy, po:FindFirstChildOfClass("Weld"))
	end)
end
...
local hamp = hamp:Clone() fix(hamp)
hamp.Parent = stuff
weld(hamend,hamp,CFrame.new(.95,-.95,0))
local hamp = hamp:Clone() fix(hamp)
hamp.Parent = stuff
